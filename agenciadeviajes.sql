...
--
-- Servidor: localhost
-- Tiempo de generación: 08-04-2020 a las 04:38:01
...
(1, 'Marcelino', 'Marcelino@correo.com', 'Una gran cuarentena. Muchs Gracias !!'),
(2, 'Pablo', 'pablo@gmail.com', 'Donec eleifend turpis sit amet urna aliquet, ut molestie ipsum semper. Etiam facilisis elementum nunc id semper. Praesent efficitur, felis sit amet interdum mattis, turpis massa congue risus, non pulvinar nisl lorem eu nulla. Pellentesque congue arcu ac nisl gravida ultrices.'),
(4, 'Miguel', 'miguel@correo.com', 'Mauris non posuere risus. In lobortis eros eleifend, eleifend sem a, fermentum odio. Phasellus commodo sem id tincidunt vestibulum.'),
(5, 'Daniel', 'Daniel@correo.com', 'Desde Controller'),
(6, 'Un Nuevo Cliente', 'cliete@correo.com', 'Probando async / awiat');
